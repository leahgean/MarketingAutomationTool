<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TotalClickthroughsListing.aspx.cs" Inherits="MarketingAutomationTool.Campaigns.Reports.TotalClickthroughsListing" MasterPageFile="~/MATSite.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server">
    ...
    <link href="../../dcjqaccordion-master/css/skins/graphite.css" rel="stylesheet" type="text/css" />
     <title>Marketing Automation Tool - Campaign Reports - Total Clickthroughs Listing</title>
</asp:Content>
     ...
     <div class="container-fluid">
				<nav class="breadcrumb">
				  ...
				  <asp:LinkButton ID="lnkCampaignReports" runat="server" CssClass="breadcrumb-item"  Text="Reports" OnClick="lnkCampaignReports_Click"  ></asp:LinkButton>
                    <span class="breadcrumb-item active">Total Clickthroughs Listing</span>
				</nav>
			</div>
</asp:Content> 
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 middlecontent">
					<div class="page_header">
                        <div class="form-horizontal">
							<div class="container">
								<div class="row">
									<h5 class="page_title">Total Clickthroughs Listing</h5>
