...
{
    public partial class UniqueClickthroughsListing : System.Web.UI.Page
    {
        ...
        private void GenerateReport(DateTime? dtStartDate, DateTime? dtEndDate)
        {
            ...
            DS_UniqueClickthroughs ds = new DS_UniqueClickthroughs();
            DataTable dt2 = oCR.GetCampaignReportUniqueClicksListing(userlogin.AccountID, dtStartDate, dtEndDate, CampaignId);


            ds.Tables["tblParameters"].Merge(dt);
            ds.Tables["tblClicks"].Merge(dt2);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("../ReportsLibrary/UniqueClicksListing.rdlc");

            ReportDataSource datasource = new ReportDataSource("DataSet1", ds.Tables["tblParameters"]);
            ReportDataSource datasource2 = new ReportDataSource("DataSet2", ds.Tables["tblClicks"]);
