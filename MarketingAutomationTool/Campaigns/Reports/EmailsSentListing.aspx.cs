...
{
    public partial class EmailsSentListing : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                ddlCampaign.Items.Insert(0, new ListItem("All Campaigns", string.Empty));
        ...
        private void GenerateReport(DateTime? dtStartDate, DateTime? dtEndDate)
        {
            ...
            DataTable dt2 = oCR.GetCampaignReportEmailsSentListing(userlogin.AccountID, dtStartDate, dtEndDate, CampaignId);


            ds.Tables["tblParameters"].Merge(dt);
            ds.Tables["tblEmailsSent"].Merge(dt2);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("../ReportsLibrary/EmailsSentListing.rdlc");

            ReportDataSource datasource = new ReportDataSource("DataSet1", ds.Tables["tblParameters"]);
            ReportDataSource datasource2 = new ReportDataSource("DataSet2", ds.Tables["tblEmailsSent"]);
