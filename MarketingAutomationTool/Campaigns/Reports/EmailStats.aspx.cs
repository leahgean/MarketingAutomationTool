...
{
    public partial class EmailStats : System.Web.UI.Page
    {
        ...
        private void GenerateReport(DateTime? dtStartDate, DateTime? dtEndDate)
        {
            ...
            DataTable dt2 = oCR.GetCampaignReportEmailStats(userlogin.AccountID,dtStartDate, dtEndDate, CampaignId);

            
            ds.Tables["tblParameters"].Merge(dt);
            ds.Tables["tblEmailStats"].Merge(dt2);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("../ReportsLibrary/EmailStats.rdlc");

            ReportDataSource datasource = new ReportDataSource("DataSet1", ds.Tables["tblParameters"]);
            ReportDataSource datasource2 = new ReportDataSource("DataSet2", ds.Tables["tblEmailStats"]);
