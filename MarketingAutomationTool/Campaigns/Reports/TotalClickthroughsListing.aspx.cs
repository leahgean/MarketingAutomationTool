...
{
    public partial class TotalClickthroughsListing : System.Web.UI.Page
    {
        ...
        private void GenerateReport(DateTime? dtStartDate, DateTime? dtEndDate)
        {
            ...
            DataTable dt2 = oCR.GetCampaignReportTotalClicksListing(userlogin.AccountID, dtStartDate, dtEndDate, CampaignId);


            ds.Tables["tblParameters"].Merge(dt);
            ds.Tables["tblClicks"].Merge(dt2);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("../ReportsLibrary/TotalClicksListing.rdlc");
