...
{
    public partial class TotalOpensListing : System.Web.UI.Page
    {
        ...
        private void GenerateReport(DateTime? dtStartDate, DateTime? dtEndDate)
        {
            ...
            DataTable dt2 = oCR.GetCampaignReportTotalOpensListing(userlogin.AccountID, dtStartDate, dtEndDate, CampaignId);


            ds.Tables["tblParameters"].Merge(dt);
            ds.Tables["tblOpens"].Merge(dt2);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("../ReportsLibrary/TotalOpensListing.rdlc");
