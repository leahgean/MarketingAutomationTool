...
{
    public partial class UnsubscribedLeadsListing : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtSources = objLeads.GetUnsubscribeSource(userlogin.AccountID);
        ...
        private void GenerateReport(DateTime? dtStartDate, DateTime? dtEndDate)
        {
            ...
            DS_UnsubscribedLeadsListing ds = new DS_UnsubscribedLeadsListing();
            DataTable dt = oLR.UnsubscribedLeadsListing(dtStartDate, dtEndDate, sSource, iType, iStatus, userlogin.AccountID, out iTotalLeadCount);

            DataTable dt2 = new DataTable();
            dt2.Columns.Add("StartDate", typeof(string));
            dt2.Columns.Add("EndDate", typeof(string));
            dt2.Columns.Add("Source", typeof(string));
            ...
            dtRow2["Source"] =  GetSource(sSource);
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("../ReportLibrary/UnsubscribedLeadsListing.rdlc");
