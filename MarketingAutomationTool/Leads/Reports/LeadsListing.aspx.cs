...
{
    public partial class LeadsListing : System.Web.UI.Page
    {
        ...
        private void GenerateReport(DateTime? dtStartDate, DateTime? dtEndDate)
        {
            ...
            DataTable dt = oLR.LeadsListing(dtStartDate, dtEndDate, sSource, iType, iStatus, userlogin.AccountID, out iTotalLeadCount);
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("../ReportLibrary/LeadsListing.rdlc");
