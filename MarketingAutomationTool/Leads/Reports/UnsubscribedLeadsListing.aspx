<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnsubscribedLeadsListing.aspx.cs" Inherits="MarketingAutomationTool.Leads.Reports.UnsubscribedLeadsListing" MasterPageFile="~/MATSite.Master" EnableEventValidation="false"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server"> 
	...
	<script type="text/javascript">
        ...
        function ValidateRequiredFields() {
            ...
            if (dStartDate > dEndDate) {
                ...
                $("#invalidStartDate").text('Unsubscribed Date Start Date cannot be greater than Unsubscribed Date End Date');
                $("#invalidStartDate").show();
                $("#<%=txtStartDate.ClientID%>").css({"border": "1px solid #dc3545", "box-shadow": "0 0 0 .2rem rgba(220,53,69,.25)"});
                return false;
            }
    ...
    <title>Marketing Automation Tool - Unsubscribed Leads Listing</title>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cpRowCrumbs" runat="server"> 
    <div class="container-fluid">
				<nav class="breadcrumb">
                  ...
                  <span class="breadcrumb-item active">Unsubscribed Leads Listing</span>
				</nav>
			</div>
</asp:Content>  
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 middlecontent">
					<div class="page_header">
                        <div class="form-horizontal">
							<div class="container">
								<div class="row">
									<h5 class="page_title">Unsubscribed Leads Listing</h5>
							        ...
							        <div class="collapse" id="paramCollapsePanel">
													...
													<div class="row">
														<div class="form-group form-group-sm col-sm-12 required">
															<div class="row">
															    <label class="col-form-label col-sm-2" >Unsubscribed Date:</label>
															    <div class="col-sm-4">
																      ...
																      <div class="input-group-prepend">
																       ...
																       <asp:TextBox ID="txtStartDate" type="date"  runat="server" class="form-control" placeholder="Date From"  aria-describedby="basic-addon1" required></asp:TextBox>
                                                                        <div id="invalidStartDate" class="invalid-feedback">
                	                                                        Please input Unsubscribed Date Start Date.
                                                                        </div>
																    </div>
															    </div>
																      ...
																      <div class="input-group-prepend">
																       ...
																       <asp:TextBox ID="txtEndDate" type="date"  runat="server" class="form-control" placeholder="Date To"  aria-describedby="basic-addon1" required></asp:TextBox>
																        <div id="invalidEndDate" class="invalid-feedback">
                	                                                        Please input Unsubscribed Date End Date.
                                                                        </div>
                                                                    </div>
															    </div>
															</div>
