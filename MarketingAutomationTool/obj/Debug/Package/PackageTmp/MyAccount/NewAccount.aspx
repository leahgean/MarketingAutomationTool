<%@ Page Title="" Language="C#" MasterPageFile="~/MATSite.Master" AutoEventWireup="true" CodeBehind="NewAccount.aspx.cs" Inherits="MarketingAutomationTool.MyAccount.NewAccount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidateRequiredFields() {
            ...
            if ($('#<%=txtCompanyName.ClientID%>').val() == '') return false;
    ...
    <title>Marketing Automation Tool - New Account</title>
</asp:Content>
                                            ...
                                            <div class="needs-validation" id="dvFormValidate" novalidate>
											    ...
											    <legend class="legendstyle">Company Details</legend>
											     <div class="form-group row required">
                                                    ...
                                                    <div class="col-sm-10">
                                                             <asp:TextBox ID="txtCompanyName" runat="server" CssClass="form-control" placeholder="Company Name" MaxLength="50"  required></asp:TextBox>
                                                            <div class="invalid-feedback">
														    ...
														    <div class="form-group form-group-sm col-sm-12">
															    ...
															    <div class="col-sm-12 button_panel">
																    <div class="float-right mt-2">
																	    ...
																	    <asp:Button ID="btnClear" runat="server" Text="Clear" class="btn btn-light" OnClick="btnClear_Click" formnovalidate />
																    </div>
															    </div>
															    </div>
														    </div>
					    ...
					    <div class="graphite accordion-container-right">
						    <ul class="accordion" id="accordion-right">
							    <li class="dcjq-current-parent"><a href="#"  class="dcjq-parent active">Shortcuts</a>
								    <ul>
									    <li>
										    <a href="/MyAccount/Accounts.aspx">View Accounts</a>
									    </li>
								    </ul>
							    </li>
							    </ul>
