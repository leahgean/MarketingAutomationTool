<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditLead.aspx.cs" Inherits="MarketingAutomationTool.Leads.EditLead" MasterPageFile="~/MATSite.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server"> 
    ...
    <title>Marketing Automation Tool - Edit Lead</title>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cpRowCrumbs" runat="server"> 
    <div class="container-fluid">
				<nav class="breadcrumb">
                  ...
                  <span class="breadcrumb-item active">Edit Lead</span>
				</nav>
			</div>
</asp:Content>  
    ...
    <uc:LeftSearch runat="server" id="LeadLeftSearch"></uc:LeftSearch>
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 middlecontent">
					<div class="page_header">
						<h5 class="page_title">Edit: <label runat="server" id="lblLeadName"></label></h5>
					</div>
                                     ...
                                     <div class="needs-validation" id="dvFormValidate" novalidate>
                                         ...
                                         <div class="row">
													<div class="form-group form-group-sm col-sm-12">
														<div class="row">
															<label class="col-form-label col-sm-2" >Lead ID:</label>
															<div class="col-sm-10">
                                                                <label class="col-form-label col-sm-10" runat="server" id="lblLeadID"></label>
															</div>
														</div>
													</div>
											</div>
															...
															<div class="col-sm-10">
																<div class="form-check">
																  <label class="col-form-label col-sm-10" >
                                                                      <asp:CheckBox ID="cbSubscribedToEmail"  class="form-check-input" runat="server" />Email
																  </label>
																</div>
															</div>
														</div>
                                         ...
                                         <div runat="server" id="dvDeleteInformation">
                                             <legend class="legendstyle">Delete Information</legend>
                                             <div class="row">
													<div class="form-group form-group-sm col-sm-12">
														<div class="row">
															<label class="col-form-label col-sm-2" >Date Deleted:</label>
															<div class="col-sm-10">
                                                                <label class="col-form-label col-sm-10" runat="server" id="lblDateDeleted"></label>
															</div>
														</div>
													</div>
											</div>
                                             <div class="row">
													<div class="form-group form-group-sm col-sm-12">
														<div class="row">
															<label class="col-form-label col-sm-2" >Deleted By:</label>
															<div class="col-sm-10">
                                                                <label class="col-form-label col-sm-10" runat="server" id="lblDeletedBy"></label>
															</div>
														</div>
													</div>
											</div>
														...
														<div class="form-group form-group-sm col-sm-12">
															...
															<div class="col-sm-12 button_panel">
																<div class="float-right mt-2">
                                                                    ...
                                                                    <asp:Button ID="btnCancel" class="btn btn-light" runat="server" Text="Cancel" OnClick="btnCancel_Click" OnClientClick="return CheckIfDeleted();" formnovalidate  />
																</div>
															</div>
															</div>
														</div>
