<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeadsStatistics.aspx.cs" Inherits="MarketingAutomationTool.Leads.Reports.NewLeadsStatistics" MasterPageFile="~/MATSite.Master" EnableEventValidation="false"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server"> 
    ...
    <title>Marketing Automation Tool - Leads Statistics</title>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cpRowCrumbs" runat="server"> 
    <div class="container-fluid">
				<nav class="breadcrumb">
                  ...
                  <span class="breadcrumb-item active">Leads Statistics</span>
				</nav>
			</div>
</asp:Content>  
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 middlecontent">
					<div class="page_header">
                        <div class="form-horizontal">
							<div class="container">
								<div class="row">
									<h5 class="page_title">Leads Statistics</h5>
												        ...
												        <div class="form-group form-group-sm col-sm-12">
													        ...
													        <div class="col-sm-12 button_panel">
														        <div class="float-right mt-2">
                                                                    <asp:Button ID="btnFilter" runat="server" Text="Apply Filters" class="btn btn-primary" OnClick="btnFilter_Click" OnClientClick="return Validate();"   />
                                                                    &nbsp;&nbsp;
