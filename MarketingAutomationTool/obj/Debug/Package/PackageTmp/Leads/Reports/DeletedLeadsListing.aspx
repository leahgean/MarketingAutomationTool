<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeletedLeadsListing.aspx.cs" Inherits="MarketingAutomationTool.Leads.Reports.DeletedLeadsListing" MasterPageFile="~/MATSite.Master" EnableEventValidation="false"      %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server"> 
	...
	<script type="text/javascript">
        ...
        function ValidateRequiredFields() {
            ...
            if (dStartDate > dEndDate) {
                ...
                $("#invalidStartDate").text('Date Deleted Start Date cannot be greater than Date Deleted End Date');
                $("#invalidStartDate").show();
                $("#<%=txtStartDate.ClientID%>").css({"border": "1px solid #dc3545", "box-shadow": "0 0 0 .2rem rgba(220,53,69,.25)"});
                return false;
            }
    ...
    <title>Marketing Automation Tool - Deleted Leads Listing</title>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cpRowCrumbs" runat="server"> 
    <div class="container-fluid">
				<nav class="breadcrumb">
                  ...
                  <span class="breadcrumb-item active">Deleted Leads Listing</span>
				</nav>
			</div>
</asp:Content>  
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 middlecontent">
					<div class="page_header">
                        <div class="form-horizontal">
							<div class="container">
								<div class="row">
									<h5 class="page_title">Deleted Leads Listing</h5>
																      ...
																      <div class="input-group-prepend">
																       ...
																       <asp:TextBox ID="txtStartDate" type="date"  runat="server" class="form-control" placeholder="Date From"  aria-describedby="basic-addon1" required></asp:TextBox>
                                                                        <div id="invalidStartDate" class="invalid-feedback">
                	                                                        Please input Date Deleted Start Date.
                                                                        </div>
																    </div>
															    </div>
																      ...
																      <div class="input-group-prepend">
																       ...
																       <asp:TextBox ID="txtEndDate" type="date"  runat="server" class="form-control" placeholder="Date To"  aria-describedby="basic-addon1" required></asp:TextBox>
																        <div id="invalidEndDate" class="invalid-feedback">
                	                                                        Please input Date Deleted End Date.
                                                                        </div>
                                                                    </div>
															    </div>
															</div>
