CREATE PROCEDURE S_Campaigns_UniqueOpensListing
...
EmailAddress NVARCHAR(250))
	...
	SET @SQLSelect='SELECT DISTINCT C.Id CampaignId, C.CampaignName,M.Id MessageId,JQ.Id JobId,JQH.[Status], C.CreatedDate, CO.ContactId, CT.FirstName, CT.LastName, CT.EmailAddress '
	...
	INSERT INTO @TotalOpens(CampaignId,CampaignName,MessageId,JobId,JobStatus,CampaignCreatedDate,ContactId,FirstName, LastName, EmailAddress)
	EXEC(@SQL)
...
--EXEC S_Campaigns_UniqueOpensListing '6388071F-36BB-4823-A3ED-8770ADAE0F51','1/2/2021','1/6/2021',28
--EXEC S_Campaigns_UniqueOpensListing '6388071F-36BB-4823-A3ED-8770ADAE0F51',NULL,NULL,NULL
--EXEC S_Campaigns_UniqueOpensListing '6388071F-36BB-4823-A3ED-8770ADAE0F51',NULL,NULL,28
