CREATE PROCEDURE S_Campaigns_EmailSentListing
...
EmailSent DATETIME)
	...
	SET @SQLSelect='SELECT C.Id CampaignId, C.CampaignName,M.Id MessageId,JQ.Id JobId,JQH.[Status], C.CreatedDate, CS.ContactId, CT.FirstName, CT.LastName, CT.EmailAddress, CS.CreatedDate EmailSentDate '
	...
	'ON CS.AccountUID=CT.AccountID AND CS.ContactID=CT.ContactID '
	...
	SET @SQLPart2='ORDER BY C.CreatedDate, CS.CreatedDate'
	...
	INSERT INTO @EmailsSent(CampaignId,CampaignName,MessageId,JobId,JobStatus,CampaignCreatedDate,ContactId,FirstName, LastName, EmailAddress, EmailSent)
	EXEC(@SQL)
...
--EXEC S_Campaigns_EmailSentListing '6388071F-36BB-4823-A3ED-8770ADAE0F51','1/2/2021','1/6/2021',28
--EXEC S_Campaigns_EmailSentListing '6388071F-36BB-4823-A3ED-8770ADAE0F51',NULL,NULL,NULL
--EXEC S_Campaigns_EmailSentListing '6388071F-36BB-4823-A3ED-8770ADAE0F51',NULL,NULL,28
