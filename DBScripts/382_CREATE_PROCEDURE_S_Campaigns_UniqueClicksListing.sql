CREATE PROCEDURE S_Campaigns_UniqueClicksListing
...
Link NVARCHAR(MAX))
	...
	SET @SQLSelect='SELECT DISTINCT C.Id CampaignId, C.CampaignName,M.Id MessageId,JQ.Id JobId,JQH.[Status], C.CreatedDate, CT.ContactId, CC.FirstName, CC.LastName, CC.EmailAddress, CT.Link '
	...
	INSERT INTO @UniqueClicks(CampaignId,CampaignName,MessageId,JobId,JobStatus,CampaignCreatedDate,ContactId,FirstName, LastName, EmailAddress,Link)
	EXEC(@SQL)
...
--EXEC S_Campaigns_UniqueClicksListing '6388071F-36BB-4823-A3ED-8770ADAE0F51','1/2/2021','1/6/2021',28
--EXEC S_Campaigns_UniqueClicksListing '6388071F-36BB-4823-A3ED-8770ADAE0F51',NULL,NULL,NULL
--EXEC S_Campaigns_UniqueClicksListing '6388071F-36BB-4823-A3ED-8770ADAE0F51',NULL,NULL,28
